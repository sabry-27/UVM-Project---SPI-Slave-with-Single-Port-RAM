    ...
    class ram_scoreboard extends uvm_scoreboard;
        ...
        task run_phase(uvm_phase phase);
            ...
            forever begin
                ...
                if (seq_item_sb.dout != dout_GM) begin
                    ...
                    error_count++;
                end else if (seq_item_sb.tx_valid != tx_valid_GM) begin
            ...
            if (~ram_seq_ref.rst_n) begin
                ...
                if (ram_seq_ref.rx_valid) begin
                    case (ram_seq_ref.din[9:8])
                        2'b00 : Wr_Addr_GM = ram_seq_ref.din[7:0];           
                        2'b01 : MEM_GM[Wr_Addr_GM] = ram_seq_ref.din[7:0];   
                        2'b10 : Rd_Addr_GM = ram_seq_ref.din[7:0];           
                        2'b11 : begin                                         
